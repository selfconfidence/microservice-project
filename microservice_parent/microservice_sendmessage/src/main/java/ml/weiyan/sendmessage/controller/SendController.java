...
public class SendController {
    ...
    public ResponseEntity sendMessage(@PathVariable("phone") String phone){
        String result = sendService.sendMessage(sendMessages6Util.smsMessageRandom(), phone);
      return new ResponseEntity(true, ResponseCode.OK,"发送成功!",result);
    }
}
