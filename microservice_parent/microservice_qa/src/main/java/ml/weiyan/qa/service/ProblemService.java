package ml.weiyan.qa.service;

import ml.weiyan.qa.dao.ProblemDao;
...
public class ProblemService {
	...
	public Page<Problem> newList(String labelid, int page,int size){
		PageRequest pageRequest =  PageRequest.of(page-1, size);
		return this.problemDao.newList(labelid,pageRequest);
	}
/**
 * 热门问答列表
 * @param labelid
...
public Page<Problem> hotList(String labelid, int page,int size){
	PageRequest pageRequest =  PageRequest.of(page-1, size);
	return this.problemDao.hotList(labelid,pageRequest);
}
	...
	public Page<Problem> waitList(String labelid, int page,int size){
		PageRequest pageRequest =  PageRequest.of(page-1, size);
		return this.problemDao.waitList(labelid,pageRequest);
	}
