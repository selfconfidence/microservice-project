...
import ml.weiyan.user.dao.AdminDao;
...
public class AdminService {
    ...
    public void add(Admin admin) throws Exception {
        ...
        Admin adminEntity = adminDao.findByLoginname(admin.getLoginname());
        if (adminEntity != null) {
    ...
    public Admin login(Admin admin) {
        //根据用户名查询数据库数据
        Admin adminEntity = adminDao.findByLoginname(admin.getLoginname());
        if (adminEntity != null && bCryptPasswordEncoder.matches(admin.getPassword(),adminEntity.getPassword())) {
            return adminEntity;
        }
